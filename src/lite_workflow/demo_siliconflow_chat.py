...
from lite_workflow.definitions.node import create_function_node, create_async_function_node
...
def create_siliconflow_graph() -> Graph:
    ...
    nodes = [
        ...
        create_async_function_node("silicon_flow_chat", silicon_flow_chat_node), # 标记为异步节点
